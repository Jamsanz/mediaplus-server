...
const app = new app_1.default([new index_route_1.default(), new posts_route_1.default(), new contact_route_1.default(), new users_route_1.default(), new auth_route_1.default()]);
app.listen();
